...
public class Orm_Instorage extends ORMDeclarator<com.spark.psi.inventory.intf.entity.instorage.mod.Instorage> {
	...
	public final QueryColumnDefine c_checkinString;
	...
	public Orm_Instorage() {
		...
		this.c_checkinString = this.orm.getColumns().get(4);
		...
		this.c_sheetType = this.orm.getColumns().get(16);
		this.c_status = this.orm.getColumns().get(17);
		this.c_stopReason = this.orm.getColumns().get(18);
		this.c_storeId = this.orm.getColumns().get(19);
		this.c_storeName = this.orm.getColumns().get(20);
		this.c_storeNamePY = this.orm.getColumns().get(21);
