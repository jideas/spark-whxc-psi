...
package com.spark.psi.inventory.intf.constant.outstorage;
...
public class OutstoStatus{

	/**
	 * 
	 */
	public OutstoStatus(Context context){
		initstatussMap();
...
//		List<ListTask> lts = Dictionary.getList(context, SAAS.DictionaryType.outstoState.toString(), null);
//		for(ListTask lt : lts){
