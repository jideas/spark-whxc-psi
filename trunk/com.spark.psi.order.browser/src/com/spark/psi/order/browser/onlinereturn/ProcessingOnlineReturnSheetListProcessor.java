 ...
 * 
 */
public class ProcessingOnlineReturnSheetListProcessor extends OnlineReturnSheetListProcessor {
	...
	public String[] getTableActionIds() {
		if (loginInfo.hasAuth(Auth.SubFunction_OnlineReturn_Confirm)) {
			return new String[] { Action.Confirm.name(), Action.Stop.name() };
		}
		return null;
	}
	@Override
...
//		countLabel.setText("" + listEntity.getItemList().size());
	...
	public void actionPerformed(String rowId, String actionName,
		...
		if (Action.Detail.name().equals(actionName)
				|| Action.Confirm.name().equals(actionName)
				|| Action.Stop.name().equals(actionName)) {
