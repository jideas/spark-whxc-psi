...
public class SubmitedProduceOrderListRender extends ProduceOrderListRender {
	...
	public STableColumn[] getColumns() {
		...
		columns[0] = new STableColumn(SubmitedProduceOrderListProcessor.ColumnName.code.name(), 300, JWT.LEFT, "订单编号");
		columns[1] = new STableColumn(SubmitedProduceOrderListProcessor.ColumnName.count.name(), 240, JWT.RIGHT, "商品数量");
		columns[2] = new STableColumn(SubmitedProduceOrderListProcessor.ColumnName.createInfo.name(), 240, JWT.LEFT, "制单");
		columns[3] = new STableColumn(SubmitedProduceOrderListProcessor.ColumnName.planFinishDate.name(), 240, JWT.CENTER, "计划完成日期");
