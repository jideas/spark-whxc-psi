...
//		打印日期：2013-01-27
		...
		summaryInfo = "商品数：" + orderInfo.getItems().length + "&nbsp;&nbsp;&nbsp;总件数：" + DoubleUtil.getRoundStr(totalCount, 0) + "&nbsp;&nbsp;&nbsp;合计：" + DoubleUtil.getRoundStr(totalAmount); 
		MemberAccountInfo memberAccount = getContext().find(MemberAccountInfo.class, orderInfo.getMemberId());
...
//					}
				...
				case 3:
					if(item.getVantagesCost()>0)
						return DoubleUtil.getRoundStr(item.getVantagesCost(),0)+"积分";
					else
