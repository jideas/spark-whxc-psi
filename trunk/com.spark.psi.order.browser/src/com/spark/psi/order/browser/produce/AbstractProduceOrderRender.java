...
public abstract class AbstractProduceOrderRender extends AbstractFormRender {
	...
	protected final void fillContent() {
		...
		text.setID(AbstractProduceOrderProcessor.ID_Text_Remark);
		
		Label label = new Label(remarkArea);
		label.setID(AbstractProduceOrderProcessor.ID_Label_StopCause);
	...
	protected final void fillHeader() {
		...
		lb.setID(AbstractProduceOrderProcessor.ID_Label_PlanDate);
		lb.setLayoutData(gd);
		
		new Label(headerRightArea).setID(AbstractProduceOrderProcessor.ID_Label_ReceiveReturn);
		new Label(headerRightArea).setText("   单据状态：");
		new Label(headerRightArea).setID(AbstractProduceOrderProcessor.ID_Label_Status);
	}
