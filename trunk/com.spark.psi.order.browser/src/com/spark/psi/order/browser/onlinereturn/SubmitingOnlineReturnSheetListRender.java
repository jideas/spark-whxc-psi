 ...
 * 
 */
public class SubmitingOnlineReturnSheetListRender extends PSIListPageRender {
	...
	protected void afterFooterRender() {
		...
		new Label(headerLeftArea).setID(SubmitingOnlineReturnSheetListProcessor.ID_Label_Count);
		new SSearchText2(headerRightArea).setID(SubmitingOnlineReturnSheetListProcessor.ID_Search);
		
		new Button(footerLeftArea, JWT.APPEARANCE3) .setID(SubmitingOnlineReturnSheetListProcessor.ID_BUTTON_SALESRETURN);
//		new Label(footerLeftArea).setText(" ");
//		new Button(footerLeftArea, JWT.APPEARANCE3) .setID(SubmitingOnlineReturnSheetListProcessor.ID_BUTTON_SUBMIT_SALESRETURN);
//		new Label(footerLeftArea, JWT.APPEARANCE3).setText(" ");
//		new Button(footerLeftArea, JWT.APPEARANCE3) .setID(SubmitingOnlineReturnSheetListProcessor.ID_BUTTON_DELETE_SALESRETURN);
	}
	...
	public STableColumn[] getColumns() {
		...
		columns[2] = new STableColumn(OlReturnColumns.Customer.name(), 180, JWT.CENTER, OlReturnColumns.Customer.title());
