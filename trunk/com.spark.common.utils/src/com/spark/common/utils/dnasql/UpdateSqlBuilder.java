...
package com.spark.common.utils.dnasql;
...
public class UpdateSqlBuilder {
	...
	public UpdateSqlBuilder(Context context) {
	...
	private List<String> nullColumns = new ArrayList<String>();
	...
	public void addColumnNull(String column) {
	...
	public void addIn(String column, String type, Object... objs) {
		StringBuilder ss = new StringBuilder("t." + column + " in (");
		...
		ss.append(")");
		this.conditions.add(ss.toString());
	}
	...
	private String getTestSql() { return "";}
