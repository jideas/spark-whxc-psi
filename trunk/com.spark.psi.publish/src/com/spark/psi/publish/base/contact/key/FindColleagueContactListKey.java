...
public class FindColleagueContactListKey extends LimitKey{
	 ...
	 *构造方法
	 */
	public FindColleagueContactListKey(){
		this(0, 10000, true);
	}
	 ...
	 */
	public FindColleagueContactListKey(int offset, int count, boolean queryTotal){
