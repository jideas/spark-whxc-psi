...
public class ORM_DeliverTicketDetByTicketId extends ORMDeclarator<com.spark.deliverticket.intf.entity.DeliverTicketDetEntity> {
	...
	public ORM_DeliverTicketDetByTicketId() {
