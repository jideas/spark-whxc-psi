...
public class Orm_SalesOrderItem2 extends ORMDeclarator<com.spark.order.sales2.SalesOrderItem2> {
	...
	public Orm_SalesOrderItem2() {
		this.arg_tenantsId = this.orm.getArguments().get(0);
		this.arg_orderId = this.orm.getArguments().get(1);
		this.c_disAmount = this.orm.getColumns().get(0);
		this.c_discount = this.orm.getColumns().get(1);
		this.c_promotionId = this.orm.getColumns().get(2);
		this.c_amount = this.orm.getColumns().get(3);
		...
		this.c_num = this.orm.getColumns().get(12);
		this.c_createDate = this.orm.getColumns().get(13);
		this.c_creator = this.orm.getColumns().get(14);
		this.c_creatorId = this.orm.getColumns().get(15);
		this.c_recid = this.orm.getColumns().get(16);
		this.c_tenantsId = this.orm.getColumns().get(17);
	}
}
