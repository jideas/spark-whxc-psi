...
public class ORM_OnlineOrderLogByOrderId extends ORMDeclarator<com.spark.onlineorder.intf.entity.OnlineOrderLogEntity> {
	...
	public ORM_OnlineOrderLogByOrderId() {
