...
public class ORM_ProduceGoodsDetByOrderId extends ORMDeclarator<com.spark.produceorder.intf.entity.ProduceGoodsDetEntity> {
	...
	public final QueryColumnDefine c_finishedCount;
	...
	public ORM_ProduceGoodsDetByOrderId() {
		...
		this.c_finishedCount = this.orm.getColumns().get(4);
