...
public class ORM_BuyOrder extends ORMDeclarator<com.spark.order.purchase.intf.entity.PurchaseOrderInfo> {
	...
	public ORM_BuyOrder() {
		...
		this.c_deliveryDate = this.orm.getColumns().get(23);
		this.c_billType = this.orm.getColumns().get(24);
	}
}
