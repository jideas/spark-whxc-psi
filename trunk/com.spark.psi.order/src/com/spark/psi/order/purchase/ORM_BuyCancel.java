...
public class ORM_BuyCancel extends ORMDeclarator<com.spark.order.purchase.intf.entity.PurchaseCancel> {
	...
	public ORM_BuyCancel() {
		...
		this.c_billType = this.orm.getColumns().get(23);
	}
}
