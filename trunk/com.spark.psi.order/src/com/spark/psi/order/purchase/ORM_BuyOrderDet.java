...
public class ORM_BuyOrderDet extends ORMDeclarator<com.spark.order.purchase.intf.entity.PurchaseOrderItem> {

	public final ArgumentDefine arg_tenants;
	public final ArgumentDefine arg_billsGuid;
	...
	public ORM_BuyOrderDet() {
		this.arg_tenants = this.orm.getArguments().get(0);
		this.arg_billsGuid = this.orm.getArguments().get(1);
		...
		this.c_scale = this.orm.getColumns().get(12);
