...
public final class TB_SA_REPORT_DEPT_SALES_DATE extends TableDeclarator {

	public static final String TABLE_NAME ="SA_REPORT_DEPT_SALES_DATE";
	...
	private TB_SA_REPORT_DEPT_SALES_DATE() {
		super(TABLE_NAME);
		this.table.setTitle("部门销售数据");
