package com.spark.psi.report.storage.inventory;
...
public final class TB_sa_report_sto_stdbook extends TableDeclarator {

	public static final String TABLE_NAME ="sa_report_sto_stdbook";
	...
	private TB_sa_report_sto_stdbook() {
		super(TABLE_NAME);
		this.table.setTitle("库存台账");
		...
		this.f_inventoryType = this.table.newField(FN_inventoryType, TypeFactory.CHAR(2));
		this.f_beginStoreCount = field = this.table.newField(FN_beginStoreCount, TypeFactory.NUMERIC(17,4));
		field.setTitle("期初库存数量");
		this.f_beginStoreMoney = field = this.table.newField(FN_beginStoreMoney, TypeFactory.NUMERIC(17,4));
		...
		field.setTitle("出库金额");
		this.f_endStoreCount = field = this.table.newField(FN_endStoreCount, TypeFactory.NUMERIC(17,4));
		field.setTitle("期末库存数量");
		this.f_endStoreMoney = field = this.table.newField(FN_endStoreMoney, TypeFactory.NUMERIC(17,4));
		...
		field.setTitle("年号");
		this.table.newIndex("index_orderNo",f_goodsNo,f_goodsName);
	}
