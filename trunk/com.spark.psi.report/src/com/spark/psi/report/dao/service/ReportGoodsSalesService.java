...
import com.spark.psi.report.dao.task.ReportGoodsSalesTask;
 ...
 * 更新商品销售数据
 */
public class ReportGoodsSalesService extends Service{

	/**
	 * @param title
	 */
	protected ReportGoodsSalesService(){
		super("ReportGoodsSalesService");
	}
	@Publish
	protected class SalesHandle extends SimpleTaskMethodHandler<ReportGoodsSalesTask>{

		@Override
		protected void handle(Context context, ReportGoodsSalesTask task) throws Throwable{
			UpdateSqlBuilder ub = new UpdateSqlBuilder(context);
			ub.setTable("SA_REPORT_GOODS_SALE_DATE");
			...
			if(0==count){
				...
				ib.setTable("SA_REPORT_GOODS_SALE_DATE");
