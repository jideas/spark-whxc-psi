...
public final class TB_CMS_ORDER extends TableDeclarator {

	public static final String TABLE_NAME ="CMS_ORDER";
	...
	private TB_CMS_ORDER() {
		super(TABLE_NAME);
		this.table.setTitle("网站订单");
		...
		this.f_verificationCode = field = this.table.newField(FN_verificationCode, TypeFactory.NVARCHAR(6));
		field.setTitle("验证码");
