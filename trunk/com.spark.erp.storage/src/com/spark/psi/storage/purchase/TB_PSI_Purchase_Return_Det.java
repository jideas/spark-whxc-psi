...
public final class TB_PSI_Purchase_Return_Det extends TableDeclarator {

	public static final String TABLE_NAME ="PSI_Purchase_Return_Det";
	...
	private TB_PSI_Purchase_Return_Det() {
		super(TABLE_NAME);
		this.table.setTitle("采购退货明细");
