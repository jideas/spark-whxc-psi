...
public final class TB_PSI_Inventory_Checkining extends TableDeclarator {

	public static final String TABLE_NAME ="PSI_Inventory_Checkining";
	...
	public final TableFieldDefine f_checkinString;
	...
	public static final String FN_checkinString ="checkinString";
	...
	private TB_PSI_Inventory_Checkining() {
		super(TABLE_NAME);
		this.table.setTitle("待入库中间表");
		...
		this.f_partnerCode = this.table.newField(FN_partnerCode, TypeFactory.NVARCHAR(50));
		...
		field.setTitle("订单总数量");
		this.f_checkinDate = field = this.table.newField(FN_checkinDate, TypeFactory.DATE);
		field.setTitle("预计入库日期");
		this.f_checkinString = field = this.table.newField(FN_checkinString, TypeFactory.NVARCHAR(1000));
		field.setTitle("确认入库字符串");
