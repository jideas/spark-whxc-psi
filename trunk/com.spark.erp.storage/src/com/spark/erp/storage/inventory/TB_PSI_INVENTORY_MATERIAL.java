...
public final class TB_PSI_INVENTORY_MATERIAL extends TableDeclarator {

	public static final String TABLE_NAME ="PSI_INVENTORY_MATERIAL";
	...
	private TB_PSI_INVENTORY_MATERIAL() {
		super(TABLE_NAME);
		...
		this.f_materialAmount = field = this.table.newField(FN_materialAmount, TypeFactory.NUMERIC(17,2));
