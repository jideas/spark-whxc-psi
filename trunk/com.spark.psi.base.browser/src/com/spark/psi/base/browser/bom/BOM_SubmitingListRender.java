...
public class BOM_SubmitingListRender extends PSIListPageRender {
	@Override
	...
	public STableColumn[] getColumns() {
		...
		columns[1] = new STableColumn(BOM_SubmitingListProcessor.Columns.bomNo.name(), 150, JWT.LEFT, "BOM编号");
		...
		columns[7] = new STableColumn(BOM_SubmitingListProcessor.Columns.status.name(), 100, JWT.CENTER, "处理状态");
