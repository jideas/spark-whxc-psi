 ...
 * 在售商品列表处理器
 */
public class OnSaleGoodsListProcessor extends GoodsCategoryFramePageProcessor {
	...
	public void process(final Situation context) {
		...
		if(loginInfo.hasAuth(Auth.SubFunction_GoodsMange_Category)) {
