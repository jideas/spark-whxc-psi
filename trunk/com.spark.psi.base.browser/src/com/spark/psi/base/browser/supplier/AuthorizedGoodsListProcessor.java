 ...
 * 
 */
public class AuthorizedGoodsListProcessor extends PSIListPageProcessor<AuthorizedGoodsItemItem> {
	...
	public void process(Situation situation) {
		...
		Label countLabel = this.createControl(ID_LABEL_B2BCOUNT, Label.class, JWT.NONE);
		countLabel.setText(String.valueOf(B2BCount));
		
		Label unCountLabel = this.createControl(ID_LABEL_UNB2BCOUNT, Label.class, JWT.NONE);
