...
public class StationInfoImpl implements StationInfo{
	...
	private long createDate	;//创建日期	date	
	private GUID 	creatorId	;//创建人Guid	guid	
	private String creator	;//创建人	nvarchar	30
	public GUID getId() {
		return id;
	}
