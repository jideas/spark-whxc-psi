...
public final class QD_GetAllPartnerList extends QueryStatementDeclarator {
		...
		public QD_GetAllPartnerList() {
			...
			this.c_cusproType = this.query.getColumns().get(5);
			this.c_busPerson = this.query.getColumns().get(6);
			this.c_province = this.query.getColumns().get(7);
			this.c_city = this.query.getColumns().get(8);
			this.c_address = this.query.getColumns().get(9);
			this.c_accountPeriod = this.query.getColumns().get(10);
			this.c_accountRemind = this.query.getColumns().get(11);
			this.c_isReflag = this.query.getColumns().get(12);
			this.c_cusproGrd = this.query.getColumns().get(13);
		}
	}
