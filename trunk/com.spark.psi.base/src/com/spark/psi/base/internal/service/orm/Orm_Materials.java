...
public class Orm_Materials extends ORMDeclarator<com.spark.psi.base.internal.entity.ormentity.MaterialsOrmEntity> {
	...
	public Orm_Materials() {
		this.arg_id = this.orm.getArguments().get(0);
		this.c_id = this.orm.getColumns().get(0);
		this.c_materialCode = this.orm.getColumns().get(1);
		this.c_materialName = this.orm.getColumns().get(2);
		this.c_categoryId = this.orm.getColumns().get(3);
		this.c_remark = this.orm.getColumns().get(4);
		this.c_canDelete = this.orm.getColumns().get(5);
		this.c_refFlag = this.orm.getColumns().get(6);
		this.c_inventoryWarningType = this.orm.getColumns().get(7);
		this.c_createDate = this.orm.getColumns().get(8);
		this.c_lastModifyDate = this.orm.getColumns().get(9);
		this.c_lastModifyPerson = this.orm.getColumns().get(10);
		this.c_creatorId = this.orm.getColumns().get(11);
		this.c_creator = this.orm.getColumns().get(12);
		this.c_namePY = this.orm.getColumns().get(13);
		this.c_status = this.orm.getColumns().get(14);
		this.c_shelfLife = this.orm.getColumns().get(15);
		this.c_warningDay = this.orm.getColumns().get(16);
		this.c_isJointVenture = this.orm.getColumns().get(17);
		this.c_supplierId = this.orm.getColumns().get(18);
		this.c_percentage = this.orm.getColumns().get(19);
	}
}
