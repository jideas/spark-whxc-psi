...
public class MaterialsTraderLog{
	...
	public MaterialsTraderLog(MaterialsTraderLogOrmEntity entity){
		this.setData(entity.getData());
		this.setMaterialsItemId(entity.getMaterialsItemId());
		this.setPartnerId(entity.getPartnerId());
	}

	public MaterialsTraderLog(){
