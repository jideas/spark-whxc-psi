...
public final class TB_SA_AUTHOR_GOODS extends TableDeclarator {

	public static final String TABLE_NAME ="SA_AUTHOR_GOODS";
	...
	private TB_SA_AUTHOR_GOODS() {
		super(TABLE_NAME);
		this.table.setTitle("授权商品明细表");
