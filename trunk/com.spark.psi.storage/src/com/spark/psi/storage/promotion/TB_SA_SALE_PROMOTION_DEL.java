...
public final class TB_SA_SALE_PROMOTION_DEL extends TableDeclarator {

	public static final String TABLE_NAME ="SA_SALE_PROMOTION_DEL";
	...
	private TB_SA_SALE_PROMOTION_DEL() {
		super(TABLE_NAME);
		this.table.setDescription("促销记录删除历史");
		this.table.setTitle("促销记录删除历史");
