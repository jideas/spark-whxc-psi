...
public final class TB_SA_REPORT_CUSTOMER_DAY extends TableDeclarator {

	public static final String TABLE_NAME ="SA_REPORT_CUSTOMER_DAY";
	...
	private TB_SA_REPORT_CUSTOMER_DAY() {
		super(TABLE_NAME);
		this.table.setTitle("客户分析数据表（按日期）");
		...
		this.table.newIndex("SA_REPORT_CUSTOMER_DAY",f_tenantsGuid,f_deptGuid,f_orderPerson,f_orderDate,f_cusProGuid);
	}
