...
public final class TB_ERP_Sales_OnlineOrder_Det extends TableDeclarator {

	public static final String TABLE_NAME ="ERP_Sales_OnlineOrder_Det";
	...
	private TB_ERP_Sales_OnlineOrder_Det() {
		super(TABLE_NAME);
		this.table.setTitle("网上订单明细");
