...
public final class TB_PSI_Base_MaterialCategory extends TableDeclarator {

	public static final String TABLE_NAME ="PSI_Base_MaterialCategory";
	...
	private TB_PSI_Base_MaterialCategory() {
		super(TABLE_NAME);
		this.table.setTitle("材料分类");
