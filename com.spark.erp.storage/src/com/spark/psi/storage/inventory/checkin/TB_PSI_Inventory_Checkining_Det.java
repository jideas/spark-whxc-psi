...
public final class TB_PSI_Inventory_Checkining_Det extends TableDeclarator {

	public static final String TABLE_NAME ="PSI_Inventory_Checkining_Det";
	...
	public final TableFieldDefine f_checkinCount;
	public final TableFieldDefine f_inspectCount;
	...
	public static final String FN_checkinCount ="checkinCount";
	public static final String FN_inspectCount ="inspectCount";

	//不可调用该构造方法.当前类只能由框架实例化.
	private TB_PSI_Inventory_Checkining_Det() {
		super(TABLE_NAME);
		this.table.setTitle("中间表明细");
		...
		field.setTitle("预计入库数量");
		this.f_checkinCount = field = this.table.newField(FN_checkinCount, TypeFactory.NUMERIC(17,5));
		field.setTitle("已入库数量");
		this.f_inspectCount = field = this.table.newField(FN_inspectCount, TypeFactory.NUMERIC(17,5));
		field.setTitle("待检数量");
	}
