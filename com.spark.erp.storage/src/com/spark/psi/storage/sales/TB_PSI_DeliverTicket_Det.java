...
public final class TB_PSI_DeliverTicket_Det extends TableDeclarator {

	public static final String TABLE_NAME ="PSI_DeliverTicket_Det";

	public final TableFieldDefine f_ticketId;
	...
	public static final String FN_ticketId ="ticketId";
	...
	private TB_PSI_DeliverTicket_Det() {
		super(TABLE_NAME);
		this.table.setTitle("发货单明细");
		TableFieldDeclare field;
		this.f_ticketId = field = this.table.newField(FN_ticketId, TypeFactory.GUID);
		...
		field.setTitle("数量");
		this.f_disRate = field = this.table.newField(FN_disRate, TypeFactory.NUMERIC(6,5));
		field.setTitle("折扣率");
