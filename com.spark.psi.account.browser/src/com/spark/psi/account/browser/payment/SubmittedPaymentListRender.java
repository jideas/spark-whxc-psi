...
public class SubmittedPaymentListRender extends PSIListPageRender {
	...
	public STableColumn[] getColumns() {
		...
		columns[0] = new STableColumn(SubmittedPaymentListProcessor.ColumnName.payDate.name(), 120, JWT.CENTER, "付款日期");
		columns[1] = new STableColumn(SubmittedPaymentListProcessor.ColumnName.sheetNo.name(), 150, JWT.LEFT, "单据编号");
		columns[2] = new STableColumn(SubmittedPaymentListProcessor.ColumnName.partnerName.name(), 120, JWT.LEFT, "付款对象");
		columns[3] = new STableColumn(SubmittedPaymentListProcessor.ColumnName.payType.name(), 120, JWT.CENTER, "付款类型");
		columns[4] = new STableColumn(SubmittedPaymentListProcessor.ColumnName.applyAmount.name(), 120, JWT.RIGHT, "申请金额");
		columns[5] = new STableColumn(SubmittedPaymentListProcessor.ColumnName.applier.name(), 120, JWT.CENTER, "申请人");
