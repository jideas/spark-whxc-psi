...
public class OnlineReturnAdvanceSearchPageProcessor extends BaseFormPageProcessor {
...
//				condition.setBillsNo(sheetNoText.getText());
				...
				condition.setCreateDateEnd(DateUtil.getDayEndTime(createDateEnd.getDate().getTime()));
