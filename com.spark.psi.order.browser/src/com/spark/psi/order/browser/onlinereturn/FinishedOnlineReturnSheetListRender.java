 ...
 * 
 */
public class FinishedOnlineReturnSheetListRender extends PSIListPageRender {
	...
	public STableColumn[] getColumns() {
		...
		columns[1] = new STableColumn(OlReturnColumns.OnlineBillsNo.name(), 150, JWT.LEFT,
				OlReturnColumns.OnlineBillsNo.title());
		columns[2] = new STableColumn(OlReturnColumns.Customer.name(), 180, JWT.LEFT, OlReturnColumns.Customer
				.title());
