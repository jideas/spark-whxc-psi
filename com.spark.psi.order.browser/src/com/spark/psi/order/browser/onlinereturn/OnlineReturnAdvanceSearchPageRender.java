...
public class OnlineReturnAdvanceSearchPageRender extends BaseFormPageRender {
...
//	public static final String ID_Date_DeliveryeDateEnd = "Date_DeliveryeDateEnd";
	...
	protected void renderButton(Composite buttonArea) {
		...
		button.setText(" 确 定 ");
		button.setID(OnlineReturnAdvanceSearchPageProcessor.ID_Button_Confirm);
		
		button = new Button(buttonArea, JWT.APPEARANCE3);
		button.setText(" 取 消 ");
		button.setID(OnlineReturnAdvanceSearchPageProcessor.ID_Button_Cancel);
	}
...
//		text.setID(OnlineReturnAdvanceSearchPageProcessor.ID_Text_BillsNo);
//		text.setLayoutData(gdOneRow);
		...
		label.setLayoutData(gdLabel);
		Text text = new Text(formArea, JWT.APPEARANCE3);
		text.setID(OnlineReturnAdvanceSearchPageProcessor.ID_Text_RealName);
		text.setLayoutData(gdOneRow);
		...
		text.setID(OnlineReturnAdvanceSearchPageProcessor.ID_Text_StationName);
		text.setLayoutData(gdOneRow);
...
//		date.setID(AdvanceSearchPageProcessor.ID_Date_CreateDateEnd);
		...
		label.setLayoutData(gdLabel);
		SDatePicker date = new SDatePicker(formArea);
		date.setID(OnlineReturnAdvanceSearchPageProcessor.ID_Date_CreateDateBegin);
		new Label(formArea).setText("至");
		date = new SDatePicker(formArea);
		date.setID(OnlineReturnAdvanceSearchPageProcessor.ID_Date_CreateDateEnd);
		
//		label = new Label(formArea);
//		label.setText("交货时间：");
//		label.setLayoutData(gdLabel);
//		LWComboList timeList = new LWComboList(formArea, JWT.APPEARANCE3);
//		timeList.setID(OnlineReturnAdvanceSearchPageProcessor.ID_List_DeliveryeTime);
	}
