 ...
 * 
 */
public class ApprovingOnlineReturnSheetListRender extends PSIListPageRender {
	...
	protected void afterFooterRender() {
		...
		new Label(headerLeftArea).setID(ApprovingOnlineReturnSheetListProcessor.ID_Label_Count);
		new SSearchText2(headerRightArea).setID(ApprovingOnlineReturnSheetListProcessor.ID_Search);
	}
