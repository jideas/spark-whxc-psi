...
public class ArrivaledOnlineOrderListProcessor<Item> extends OnlinOrderListProcessor<Item> {
	...
	public Object[] getElements(Context context, STableStatus tablestatus) {
		...
		key.setStatus(OnlineOrderStatus.Arrivaled);
		...
		amountLabel.setText("" + DoubleUtil.round(getTotalAmount(listEntity.getItemList()),2));
