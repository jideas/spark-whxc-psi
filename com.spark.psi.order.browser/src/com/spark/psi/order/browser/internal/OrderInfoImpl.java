...
public class OrderInfoImpl implements com.spark.psi.publish.order.entity.OrderInfo{
	...
	@StructField
	protected ContactBookInfo contactBookInfo;  //联系人
	@StructField
	protected ContactBookInfo consigneeInfo;  //收货人信息
	@StructField
	...
	/**
	 * @param contactBookInfo the contactBookInfo to set
	 */
	public void setContactBookInfo(ContactBookInfo contactBookInfo) {
		this.contactBookInfo = contactBookInfo;
	}
	/**
	 * @param consigneeInfo the consigneeInfo to set
	 */
	public void setConsigneeInfo(ContactBookInfo consigneeInfo) {
