 ...
 * @version 2012-5-4
 */
public class CustomerContactListRender extends ContactBaseListRender{
	@Override
	protected void afterFooterRender(){
		super.afterFooterRender();
		//发送短信
		Button sendMsgButton = new Button(footerLeftArea, JWT.APPEARANCE3);
		sendMsgButton.setID(CustomerContactListProcessor.ID_BUTTON_SENDMSG);
		sendMsgButton.setText("发送短信");
		//发送邮件
		Button sendEmailButton = new Button(footerLeftArea, JWT.APPEARANCE3);
		sendEmailButton.setID(CustomerContactListProcessor.ID_BUTTON_SENDMAIL);
	...
	public String getText(Object element, int columnIndex){
		...
		switch(columnIndex){
	        case 0:
	        	text = StableUtil.toLink(CustomerContactListProcessor.ID_ACTION_VIEW, "", contactPersonItem.getName());
		        break;
	        case 1:
