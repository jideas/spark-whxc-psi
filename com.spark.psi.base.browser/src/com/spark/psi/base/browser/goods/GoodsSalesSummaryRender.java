 ...
 * 指定商品的销售情况列表视图
 */
public class GoodsSalesSummaryRender extends PSIListPageRender {
	@Override
...
//		super.afterFooterRender();
	...
	public STableColumn[] getColumns() {
		...
		columns[0] = new STableColumn("", 100, JWT.CENTER, "客户名称");
		columns[1] = new STableColumn("", 100, JWT.CENTER, "商品属性");
		columns[1].setGrab(true);
		columns[2] = new STableColumn("", 50, JWT.CENTER, "单位");
		columns[3] = new STableColumn("", 65, JWT.CENTER, "销售次数");
		
		columns[4] = new STableColumn("", 90, JWT.CENTER, "累计销售数量");
		columns[5] = new STableColumn("", 90, JWT.CENTER, "最近销售数量");
		columns[6] = new STableColumn("", 90, JWT.CENTER, "最近销售单价");
		columns[7] = new STableColumn("", 90, JWT.CENTER, "最近销售日期");
		return columns;
	}
