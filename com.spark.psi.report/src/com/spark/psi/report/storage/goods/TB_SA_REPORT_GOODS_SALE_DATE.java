...
public final class TB_SA_REPORT_GOODS_SALE_DATE extends TableDeclarator {

	public static final String TABLE_NAME ="SA_REPORT_GOODS_SALE_DATE";
	...
	private TB_SA_REPORT_GOODS_SALE_DATE() {
		super(TABLE_NAME);
		this.table.setTitle("销售商品分析数据表（按月份）");
		...
		this.table.newIndex("SA_REPORT_GOODS_SALE_MONO",f_tenantId,f_goodsItemId,f_dateNo,f_deptGuid,f_orderPerson);
		this.table.newIndex("SA_REPORT_GOODS_SALE_MONT",f_tenantId,f_goodsItemId,f_monthNo,f_deptGuid,f_orderPerson);
	}
