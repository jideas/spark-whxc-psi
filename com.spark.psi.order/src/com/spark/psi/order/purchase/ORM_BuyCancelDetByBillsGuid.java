...
public class ORM_BuyCancelDetByBillsGuid extends ORMDeclarator<com.spark.order.purchase.intf.entity.PurchaseCancelItem> {
	...
	public ORM_BuyCancelDetByBillsGuid() {
