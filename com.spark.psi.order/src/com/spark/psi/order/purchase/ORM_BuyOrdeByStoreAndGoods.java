...
public class ORM_BuyOrdeByStoreAndGoods extends ORMDeclarator<com.spark.order.purchase.intf.entity.PurchaseOrderInfo> {

	public final ArgumentDefine arg_tenants;
	public final ArgumentDefine arg_storeId;
	public final ArgumentDefine arg_goodsItemId;
	...
	public ORM_BuyOrdeByStoreAndGoods() {
		this.arg_tenants = this.orm.getArguments().get(0);
		this.arg_storeId = this.orm.getArguments().get(1);
		this.arg_goodsItemId = this.orm.getArguments().get(2);
