...
public class ORM_ProduceMaterialDetByOrderId extends ORMDeclarator<com.spark.produceorder.intf.entity.ProduceMaterialDetEntity> {
	...
	public ORM_ProduceMaterialDetByOrderId() {
