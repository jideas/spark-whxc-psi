...
public class Orm_Promotion2ByGoods extends ORMDeclarator<com.spark.order.promotion.intf.Promotion2> {

	public final ArgumentDefine arg_tenantsId;
	public final ArgumentDefine arg_goodsId;
	public final ArgumentDefine arg_promotioning;
	...
	public Orm_Promotion2ByGoods() {
		this.arg_tenantsId = this.orm.getArguments().get(0);
		this.arg_goodsId = this.orm.getArguments().get(1);
		this.arg_promotioning = this.orm.getArguments().get(2);
