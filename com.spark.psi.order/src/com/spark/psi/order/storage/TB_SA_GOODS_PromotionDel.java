...
public final class TB_SA_GOODS_PromotionDel extends TableDeclarator {

	public static final String TABLE_NAME ="SA_GOODS_PromotionDel";
	...
	private TB_SA_GOODS_PromotionDel() {
		super(TABLE_NAME);
		this.table.setTitle("促销2删除记录");
