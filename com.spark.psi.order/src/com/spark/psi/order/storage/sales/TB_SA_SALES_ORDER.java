...
public final class TB_SA_SALES_ORDER extends TableDeclarator {

	public static final String TABLE_NAME ="SA_SALES_ORDER";
	...
	public final TableFieldDefine f_field_25;
	...
	public final TableFieldDefine f_consigneePhone;
	...
	public final TableFieldDefine f_examDeptId;
	public final TableFieldDefine f_isAllot;
	public final TableFieldDefine f_purchaseOrderId;
	public final TableFieldDefine f_tenantsIdB;
	public final TableFieldDefine f_planOutDate;
	public final TableFieldDefine f_field_38;
	...
	public static final String FN_field_25 ="field_25";
	...
	public static final String FN_consigneePhone ="consigneePhone";
	...
	public static final String FN_examDeptId ="examDeptId";
	public static final String FN_isAllot ="isAllot";
	public static final String FN_purchaseOrderId ="purchaseOrderId";
	public static final String FN_tenantsIdB ="tenantsIdB";
	public static final String FN_planOutDate ="planOutDate";
	public static final String FN_field_38 ="field_38";
	...
	private TB_SA_SALES_ORDER() {
		super(TABLE_NAME);
		this.table.setTitle("存放销售订单信息");
		...
		this.f_field_25 = this.table.newField(FN_field_25, TypeFactory.VARCHAR(10));
		...
		this.f_consigneePhone = field = this.table.newField(FN_consigneePhone, TypeFactory.NVARCHAR(30));
		field.setTitle("收货人手机");
		...
		field.setTitle("整单折扣");
		this.f_examDeptId = field = this.table.newField(FN_examDeptId, TypeFactory.GUID);
		field.setTitle("审核部门");
		this.f_isAllot = field = this.table.newField(FN_isAllot, TypeFactory.BOOLEAN);
		field.setTitle("是否分配");
		this.f_purchaseOrderId = field = this.table.newField(FN_purchaseOrderId, TypeFactory.GUID);
		field.setTitle("在线下单采购订单GUID");
		this.f_tenantsIdB = field = this.table.newField(FN_tenantsIdB, TypeFactory.GUID);
		field.setTitle("远程租户GUID");
		this.f_planOutDate = field = this.table.newField(FN_planOutDate, TypeFactory.DATE);
		field.setTitle("预计出库日期");
		this.f_field_38 = this.table.newField(FN_field_38, TypeFactory.VARCHAR(10));
		...
		this.table.newIndex("SA_SALES_ORDER_1",f_tenantsId,f_state,f_deptId);
		this.table.newIndex("SA_SALES_ORDER_2",f_tenantsId,f_creatorId);
	}
