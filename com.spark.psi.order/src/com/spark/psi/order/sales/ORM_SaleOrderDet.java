...
public class ORM_SaleOrderDet extends ORMDeclarator<com.spark.order.sales.intf.entity.SaleOrderItem> {

	public final ArgumentDefine arg_tenants;
	public final ArgumentDefine arg_bills;
	...
	public ORM_SaleOrderDet() {
		this.arg_tenants = this.orm.getArguments().get(0);
		this.arg_bills = this.orm.getArguments().get(1);
