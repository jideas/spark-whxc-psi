...
public class ORM_SaleOrder extends ORMDeclarator<com.spark.order.sales.intf.entity.SaleOrderInfo> {
	...
	public final QueryColumnDefine c_isAllot;

	public ORM_SaleOrder() {
		...
		this.c_billsNo = this.orm.getColumns().get(6);
		this.c_createDate = this.orm.getColumns().get(7);
		this.c_creatorId = this.orm.getColumns().get(8);
		this.c_isStoped = this.orm.getColumns().get(9);
		this.c_rejectReason = this.orm.getColumns().get(10);
		this.c_remark = this.orm.getColumns().get(11);
		this.c_status = this.orm.getColumns().get(12);
		this.c_stopReason = this.orm.getColumns().get(13);
		this.c_totalAmount = this.orm.getColumns().get(14);
		this.c_billType = this.orm.getColumns().get(15);
		this.c_isAllot = this.orm.getColumns().get(16);
	}
}
