...
public final class QD_GetContactInfoListByPartnerId extends QueryStatementDeclarator {
		...
		public QD_GetContactInfoListByPartnerId() {
			...
			this.c_position = this.query.getColumns().get(7);
			this.c_qqNumber = this.query.getColumns().get(8);
			this.c_msnNumber = this.query.getColumns().get(9);
			this.c_wwNumber = this.query.getColumns().get(10);
			this.c_birth = this.query.getColumns().get(11);
			this.c_hobbies = this.query.getColumns().get(12);
			this.c_memo = this.query.getColumns().get(13);
			this.c_partnerId = this.query.getColumns().get(14);
			this.c_province = this.query.getColumns().get(15);
			this.c_city = this.query.getColumns().get(16);
			this.c_district = this.query.getColumns().get(17);
			this.c_address = this.query.getColumns().get(18);
			this.c_postCode = this.query.getColumns().get(19);
			this.c_recid = this.query.getColumns().get(20);
			this.c_main = this.query.getColumns().get(21);
			this.c_company = this.query.getColumns().get(22);
			this.c_lastDate = this.query.getColumns().get(23);
		}
	}
