...
public class Orm_Partner extends ORMDeclarator<com.spark.psi.base.internal.entity.ormentity.PartnerOrmEntity> {
	...
	public final QueryColumnDefine c_partnerGrd;
	public final QueryColumnDefine c_busPerson;
	public final QueryColumnDefine c_used;
	...
	public Orm_Partner() {
		...
		this.c_shortName = this.orm.getColumns().get(3);
		...
		this.c_workPhoneNumber = this.orm.getColumns().get(12);
		this.c_faxNumber = this.orm.getColumns().get(13);
		this.c_province = this.orm.getColumns().get(14);
		this.c_city = this.orm.getColumns().get(15);
		this.c_district = this.orm.getColumns().get(16);
		...
		this.c_partnerGrd = this.orm.getColumns().get(26);
		this.c_busPerson = this.orm.getColumns().get(27);
		this.c_used = this.orm.getColumns().get(28);
	}
}
