 ...
 * 采购退货出库单列表处理器
 */
public class PurchaseReturnCheckingOutListProcessor extends PSIListPageProcessor<CheckingOutItem> {
	...
	{
		CreateDate,SheetNumber,RelatedNumber,StoreName,CheckoutEmployees,status
	}
	...
	public Object[] getElements(Context context, STableStatus tablestatus) {
		...
		key.setType(CheckingOutType.Return);
