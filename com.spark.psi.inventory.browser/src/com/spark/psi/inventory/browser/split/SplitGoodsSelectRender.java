...
import com.spark.psi.inventory.browser.split.SplitGoodsSelectProcessor.StoreAndGoodsItemListProcessor;
import com.spark.psi.inventory.browser.split.SplitGoodsSelectProcessor.StoreAndGoodsItemListProcessor.Item;
...
//			storeList.setID(StoreAndGoodsItemListProcessor.ID_List_Store);
		...
		public STableColumn[] getColumns() {
			STableColumn[] columns = new STableColumn[SplitGoodsSelectProcessor.Columns.values().length];
			int index = 0;
			for (SplitGoodsSelectProcessor.Columns column : SplitGoodsSelectProcessor.Columns.values()) {
				if (SplitGoodsSelectProcessor.Columns.Count == column) {
