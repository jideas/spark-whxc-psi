...
public class InventoryShelfInfoPageRender extends BaseFormPageRender {

	@Override
	protected void renderButton(Composite buttonArea) {
		Button confirmBtn = new Button(buttonArea, JWT.APPEARANCE3);
		confirmBtn.setText(" È·¶¨ ");
		confirmBtn.setID(InventoryShelfInfoPageProcessor.ID_Button_Confirm);
	}
	...
	protected void renderFormArea(Composite formArea) {
		...
		composite.setID(InventoryShelfInfoPageProcessor.ID_Area_Content);
