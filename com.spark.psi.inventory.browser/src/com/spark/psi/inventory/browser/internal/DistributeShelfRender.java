...
public class DistributeShelfRender extends BaseFormPageRender {
	...
	protected final void renderFormArea(Composite formArea) {
		...
		composite.setID(DistributeShelfProcessor.ID_Area_Content);
	}
	...
	@Override
	protected final boolean customizeButtonLayout() {
		return false;
	}
	...
	protected void renderButton(Composite buttonArea) {
		...
		confirmBtn.setID(DistributeShelfProcessor.ID_Button_Confirm);
	}
