...
public final class TB_SA_REPORT_GOODS_BUY_DAY extends TableDeclarator {

	public static final String TABLE_NAME ="SA_REPORT_GOODS_BUY_DAY";
	...
	private TB_SA_REPORT_GOODS_BUY_DAY() {
		super(TABLE_NAME);
		...
		field.setTitle("制单人");
		this.table.newIndex("SA_REPORT_GOODS_BUY_DAY",f_tenantsGuid,f_goodsPropertyGuid,f_orderDate,f_deptGuid,f_orderPerson);
	}
