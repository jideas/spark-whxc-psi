...
public final class TB_SA_REPORT_SALE_MON extends TableDeclarator {

	public static final String TABLE_NAME ="SA_REPORT_SALE_MON";
	...
	private TB_SA_REPORT_SALE_MON() {
		super(TABLE_NAME);
		this.table.setTitle("销售分析数据表（按月份）");
		...
		this.table.newIndex("SA_REPORT_SALE_MON_ONE",f_tenantsGuid,f_monthNo,f_orderPerson,f_deptGuid);
		this.table.newIndex("SA_REPORT_SALE_MON_TWO",f_tenantsGuid,f_quarter,f_orderPerson,f_deptGuid);
	}
