...
public final class TB_SA_REPORT_BUY_DAY extends TableDeclarator {

	public static final String TABLE_NAME ="SA_REPORT_BUY_DAY";
	...
	private TB_SA_REPORT_BUY_DAY() {
		...
		field.setDefault(ConstExpression.builder.expOf(0.0));
		this.table.newIndex("SA_REPORT_BUY_DAY_ONE",f_tenantsGuid,f_deptGuid,f_orderPerson,f_orderDate);
	}
